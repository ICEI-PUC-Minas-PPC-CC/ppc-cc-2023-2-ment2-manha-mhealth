...
|**Camila Fiães**|           |                             | 
|-------------------|-----------|-----------------------------|
<img src="file:///C:/Users/w10/Desktop/persona1.png" width="200" height="200"/>|**Idade:** 38 anos. **Naturalidade:** Contagem - Minas Gerais. **Ocupação:** Caixa de Supermercado.       |**Atribuições:** gerenciar operações com clientes usando caixas registradoras. 
